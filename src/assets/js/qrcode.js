(function ($) {
    ...
    var QRCode = function (text, level, version, quiet) {
            ...
            // `qrcode` is the single public function that will be defined by the `QR Code
        ...
        arcToAvailable = Object
            .prototype
            .toString
            .call(window.opera) !== '[object Opera]',

        // Returns a minimal QR code for the given text starting with version
        // `minVersion`. Returns `null` if `text` is too long to be encoded in
        // `maxVersion`.
    ...
    // jQuery.qrcode plug in code ends here QR Code Generator =================
    // ---------------------------------------------------------------------
    //
